...
func (t Training) TrainingInfo() InfoMessage {
	...
	infoMessage.Duration = t.Duration
	infoMessage.Distance = t.distance()
	infoMessage.Speed = t.meanSpeed()
	infoMessage.Calories = t.Calories()
	return infoMessage
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(w.Training.meanSpeed()*KmHInMsec, 2)/(w.Height/CmInM))*
		CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return float64(s.LengthPool) * float64(s.CountPool) / MInKm / float64(s.Training.Duration)
}
